...
function CollectionSpaceApi(opts) {
  ...
  this.backend     = this.opts.backend;
  this.validateSSL = this.opts.validateSSL || false;
  this.timeout     = this.opts.timeout || 30000;
  this.auth        = {
  ...
  this.deleteByPath = function(path, callback) {
    return doDelete(path, callback);
  };
  ...
  // GENERIC GET METHODS
  this.getItemByPath = function(path, params, callback) {
    return doGet(path, 'document', params, callback);
  };

  this.getListByPath = function(path, params, callback) {
    return doGet(path, 'ns2:abstract-common-list', params, callback);
  };

  // SERVICE SPECIFIC GET METHODS
